...
const NewPostWindow = ({ open, onOpenChange, onSubmit, categories, tagOptions, activeCategory}) =>{
  ...
  return(
    <Dialog open={open} onOpenChange={onOpenChange} className={cn("fixed inset-0 z-50 flex items-center justify-center", open ? "bg-black/20 backdrop-blur-md": "bg-transparent")}>
      <DialogContent classname="sm:max-w-lg">
        ...
        <div className='space-y-4 py-4 max-w-md max-h-screen'>
          <div className='space-y-2'>
            ...
            {/* radiobox component to select category*/}
            <div>
            ...
            {/* tags with popover + checkbox components */}
            <div>
